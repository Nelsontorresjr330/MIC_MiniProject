"""
This script is called by the plugin-wrapper, checkSolution.js, which passes down the
...
plugin = checkSolution(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
