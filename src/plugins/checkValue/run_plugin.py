"""
This script is called by the plugin-wrapper, checkValue.js, which passes down the
...
plugin = checkValue(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
