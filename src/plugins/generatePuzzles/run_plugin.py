"""
This script is called by the plugin-wrapper, generatePuzzles.js, which passes down the
...
from generatePuzzles import generatePuzzles
...
plugin = generatePuzzles(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
