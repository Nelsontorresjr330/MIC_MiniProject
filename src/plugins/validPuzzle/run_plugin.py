"""
This script is called by the plugin-wrapper, validPuzzle.js, which passes down the
...
plugin = validPuzzle(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
